...
verse = str(input("Введите стих Винни, слова отделяйте дефисами, а фразы пробелами: "))
strings = verse.split()
count_vowels = []
for i in range(len(strings)):
    count_vowels.append(len(re.findall('[уеыаоэяиюioyuea]', strings[i], re.IGNORECASE)))
uniq_count_of_vowels = set(count_vowels)

if len(uniq_count_of_vowels) > 1:
    print("Пам парам")
else:
    print('Парам пам-пам')
